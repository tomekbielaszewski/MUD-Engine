...
public interface AdministratorService {
    ...
    void give(String player, int amount, String itemId, PlayerContext admin, PlayerResponse adminResponse);
    void give(int amount, String itemName, PlayerContext admin, PlayerResponse adminResponse);
    void put(String locationId, int amount, String itemId, PlayerContext admin, PlayerResponse adminResponse);
